...
<!--% Calculez la corrélation linéaire de Pearson entre la hauteur et la circonférence des arbres ne utilisant la fonction `cor()`. -->
...
<!--% Calculez la corrélation non linéaire de Spearman entre la hauteur et la circonférence des arbres ne utilisant la fonction `cor()` pour comparaison. -->
