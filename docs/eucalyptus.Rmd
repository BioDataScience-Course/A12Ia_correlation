...
<!--% Ajoutez des labels et des unités aux variables. La variable `ht` représente la hauteur en mètre des arbres. La variable `circ` représente la circonférence en centimètre. -->
...
<!--% Effectuez un test d'hypothèse pour mettre en avant la corrélation entre la hauteur et la circonférence des eucalyptus. Interprétez votre test. N'oubliez pas de fixer la valeur du seuil alpha avant de réaliser votre test. -->
